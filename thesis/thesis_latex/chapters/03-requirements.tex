...
Infine, la validazione prevista per il prototipo combina controlli statici, build, test unitari automatizzati sulla logica pura e scenari manuali ripetibili. Non viene assunta la presenza di una suite completa di test di integrazione ed end-to-end, né di una copertura unitaria estesa all'intero codice applicativo. Questa scelta costituisce un limite metodologico, ma è coerente con l'obiettivo di verificare i flussi principali del sistema in relazione ai requisiti definiti in questo capitolo.
