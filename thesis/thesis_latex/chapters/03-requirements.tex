...
\begin{longtable}{p{0.12\textwidth}p{0.28\textwidth}p{0.48\textwidth}}
    ...
    \midrule
    \endhead
    RF-01 & Account & Il sistema deve consentire la registrazione di un nuovo utente tramite nome, email e password. \\
...
Infine, la validazione prevista per il prototipo combina controlli statici, build, test unitari automatizzati sulla logica pura, test di integrazione mirati ai vincoli di autorizzazione, uno smoke test end-to-end sul percorso critico e scenari manuali ripetibili. Non viene assunta la presenza di una suite end-to-end estesa, né di una copertura automatica dell'intero codice applicativo o di tutti i flussi funzionali. Questa scelta costituisce un limite metodologico, ma è coerente con l'obiettivo di verificare i flussi principali del sistema in relazione ai requisiti definiti in questo capitolo.
